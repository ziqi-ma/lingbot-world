...
sys.path.insert(0, '/data/ziqi/Repos/HY-WorldPlay/hyvideo')
...
FORWARD_SPEED = 0.02       # meters per frame
YAW_SPEED = np.deg2rad(0.75)   # radians per frame (3°)
PITCH_SPEED = np.deg2rad(0.75) # radians per frame (3°)
FRAMES_PER_LATENT = 4
